...
const TransparentButton = ({title,onClick}:{title:string,onClick?:()=>void}) => {
    return (
        ...
        className="px-6 w-full md:w-fit py-3 m-2 border-2 border-[#3B82F6] text-[#9333EA]  font-medium rounded-lg hover:bg-[#3B82F6]/10 transition-all duration-300 backdrop-blur-sm relative group overflow-hidden">
